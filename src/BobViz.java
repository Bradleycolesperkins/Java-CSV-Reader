...
public class BobViz extends JFrame {
    ...
    */
    ...
    /**
     * 
     * @return the second DataAttribute instance
     */
    public DataAttribute GetSecondDataAttribute() {
        return m_SecondDataAttribute;
    }
    ...
    public Table GetTableJPan() {
    	m_TableJPan = new Table(m_BV.m_Dataset.GetArrayBackwards(), 
    			m_BV.m_Dataset.GetColHeaders(), m_BV.m_Dataset.GetFileLocation());
        return m_TableJPan;
    }
    /**
     * @return m_TableJPan
    ...
    public Table GetSecondTableJPan() {
    	m_SecondTableJPan = new Table(m_BV.m_Dataset.GetArrayBackwards(), 
    			m_BV.m_Dataset.GetColHeaders(), m_BV.m_Dataset.GetFileLocation(),
    			m_BV.m_SecondDataset.GetArrayBackwards(), 
    			m_BV.m_SecondDataset.GetColHeaders(),  m_BV.m_SecondDataset.GetFileLocation());
    ...
    private DataAttribute m_SecondDataAttribute = new DataAttribute();
    ...
    private final String FRAME_TITLE = "BobViz v2.0 - PDM1 ";
