...
public class VizTypeJPanel extends JPanel {
    ...
    public Boolean BubbleChartButton(){
    	return m_BubbleChartButton.isSelected();
    }
    	...
    	public void itemStateChanged(ItemEvent e) {
 		   if(e.getSource() == m_BubbleChartButton) {
 			   if(m_BubbleChartButton.isSelected()) {
 				  ...
 				  m_BV.GetSettingJPan().GetSecondZAxisComboBox().setEnabled(true);
 			   } else {
 				  m_BV.GetSettingJPan().GetZAxisComboBox().setEnabled(false);
 				  m_BV.GetSettingJPan().GetSecondZAxisComboBox().setEnabled(false);
 			   }
 		   }
 	   	}
    }
    private ImportJPanel m_ImportJPanel;
   /**
